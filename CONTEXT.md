...
**Builder**:
The policy that **builds decks**: constructs a decklist from the card pool (masked card-adds) and refines it by mutation (card swaps). Distinct from the Pilot; the Builder never plays a duel.
